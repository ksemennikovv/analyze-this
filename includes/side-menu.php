  ...
  <div id="menuAuthedArea" style="display:none">
    <div class="side-menu__user">
      ...
      <div>
        ...
        <div id="menuUserEmail" class="side-menu__email"></div>
      </div>
    </div>
    <div class="side-menu__plan">
      ...
      <span id="menuPlanName">Стартовый · бесплатный</span>
    </div>
    <div class="side-menu__balance">
      Разборов: <strong id="menuCreditBalance">—</strong>
    </div>
    <div class="side-menu__divider"></div>
    <nav class="side-menu__nav">
      <a href="/dashboard.php" class="side-menu__nav-item">
      ...
      <a href="/meditations.php" class="side-menu__nav-item">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M9 18V5l12-2v13" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><circle cx="6" cy="18" r="3" stroke="currentColor" stroke-width="1.6"/><circle cx="18" cy="16" r="3" stroke="currentColor" stroke-width="1.6"/></svg>
        Медитации
      </a>
      <a href="/billing.php" class="side-menu__nav-item">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><rect x="1" y="4" width="22" height="16" rx="2" stroke="currentColor" stroke-width="1.6"/><path d="M1 10h22" stroke="currentColor" stroke-width="1.6"/></svg>
        Подписка и оплата
      </a>
    </nav>
  </div>
